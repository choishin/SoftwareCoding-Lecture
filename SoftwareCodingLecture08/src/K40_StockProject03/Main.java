...
//4.주식정보 가공하기 (스스로 실습1.삼성전자 (단축코드 A005930)만 추출하여 A005930.csv 파일을 만드시오)
public class Main {
	...
	public static void main(String[] args) throws IOException {
		...
		File K40_f1 = new File("C:\\Users\\최신\\Desktop\\day_data\\A005930.csv"); 
		...
		while((K40_readtxt= K40_br.readLine()) !=null){ //(3) while반복문 (무한반복)
			...
			//if 조건문 : 2번째 필드부터확인 시작, field[2]항목에 포함된 '^'를 ""으로 바꿔주고, 공백은 없애고 항목에 'A005930'가 포함된 항목이 있다면
